...
const Profile: React.FC<{}> = () => {
  ...
  const { userDataProfile, actions, styles } = useProfileDataHandler();
    ...
    <Layout>
      <View style={styles.container}>
        <View style={styles.profileContainer}>
          <Avatar
            source={{ uri: userDataProfile.avatar }}
            size="lg"
            shape="round"
            style={styles.avatar}
          />
          <View style={styles.infoContainer}>
            <Text style={[styles.userNameText, { color: textColor }]}>{userDataProfile.name}</Text>
            {userDataProfile.userType === 'farmer' || userDataProfile.userType === 'customer' && (
              <View style={styles.badgesContainer}>
                {userDataProfile.badges.map((badge) => (
